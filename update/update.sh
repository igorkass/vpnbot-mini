...
do
    ...
    then
        ...
        then
            ...
            git reset --hard origin/$current_branch > ./update/message
        fi
        ...
        > $pwd/update/key
        > $pwd/update/curl
        IP=$(hostname -I | awk '{print $1}') VER=$(git describe --tags --always) docker compose --env-file ./.env --env-file ./override.env up -d --force-recreate
